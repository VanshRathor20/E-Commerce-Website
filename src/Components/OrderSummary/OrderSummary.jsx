  ...
  return (
    <>
      <section className="fixed inset-0 z-[9998] flex items-center justify-center bg-black/60">
        <div className="bg-[#FFFFFF] w-[90vw] sm:w-full max-w-[560px] p-[24px] sm:p-[40px] border border-[#E1E1E1] shadow-2xl z-[9999] fixed top-[50%] left-[50%] transform -translate-x-[50%] -translate-y-[50%]">
          <button
            onClick={onClose}
          ...
          <div className="space-y-4 max-h-[40vh] overflow-y-auto scroll pr-2">
            {cart.length === 0 ? (
              ...
              cart.map((item) => (
                <div
                  key={item.id}
                  className="flex justify-between items-center border-b border-[#E1E1E1] pb-3"
                >
                  <div className="flex items-center gap-4">
                    ...
                    <span className="text-[#000000] text-[13px] font-semibold uppercase tracking-[0.1em] leading-tight">
                      ...
                      <span className="text-[#757575] text-[12px] ml-1">
                        x{item.quantity}
                      </span>
                    </span>
                  </div>
          ...
          <div className="mt-8 space-y-3">
            <div className="flex justify-between text-[13px]">
              <span className="text-[#000000] uppercase tracking-[0.1em] font-bold">
                SUBTOTAL
              </span>
          ...
          <div className="flex mt-8 gap-x-4">
            ...
            <button
              onClick={() => setShowOrderPlace(true)}

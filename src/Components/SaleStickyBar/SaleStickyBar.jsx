// ⚡ Make sure you have added Lightswind CSS in your public/index.html head:
    ...
    <section className="bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 shadow-lg font-primarylw sticky top-23 z-50">
      <div className="relative px-6 py-3 sm:py-4 lg:py-5">
        <div className="flex items-center justify-between pr-10">
          ...
          {/* Countdown Timer */}
          <div className="countdown flex items-center gap-1 text-xs font-medium text-white sm:gap-2 sm:text-sm">
          ...
          {/* Shop Now Link (visible on larger screens) */}
          <a
            href="#"
        ...
        <button
          type="button"
          className="absolute right-3 top-1/2 -translate-y-1/2 flex h-8 w-8 items-center justify-center rounded-full bg-white/10 text-white/70 hover:bg-white/20 hover:text-white z-10"
          onClick={(e) => e.target.closest("section").remove()} // hides bar on click
        >
          <svg
            width="16"
            height="16"
